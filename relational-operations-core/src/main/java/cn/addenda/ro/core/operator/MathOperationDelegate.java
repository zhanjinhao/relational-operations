...
import cn.addenda.ro.core.OperatorException;
 ...
 */
public class MathOperationDelegate {
    ...
    public static Object negate(Object object) {
        ...
        throw new OperatorException("只能对 BigDecimal、BigInteger、Double、Float、Byte、Short、Integer、Long 八种数据类型进行取负数运算");
    }
    ...
    public static boolean nand(Object object) {
        ...
        throw new OperatorException("只能对 Boolean 类型的数据进行与非运算");
    }
    ...
    public static Object plus(Object left, Object right) {
        ...
        throw new OperatorException("只能对 BigDecimal、BigInteger、Double、Float、Short、Integer、Byte、Long、String 九种数据类型进行加法运算");
    }
    ...
    public static Object minus(Object left, Object right) {
        ...
        throw new OperatorException("只能对 BigDecimal、BigInteger、Double、Float、Short、Integer、Byte、Long 八种数据类型进行减法运算");
    }
    ...
    public static Object multiply(Object left, Object right) {
        ...
        throw new OperatorException("只能对 BigDecimal、BigInteger、Double、Float、Short、Integer、Byte、Long 八种数据类型进行乘法运算");
    }
    ...
    public static Object divide(Object left, Object right) {
        ...
        if (left instanceof BigDecimal && right instanceof BigDecimal) {
            ...
            if (rightBigDecimal.compareTo(BIG_DECIMAL_ZERO) == 0) {
                throw new OperatorException("除法的右操作数不能为0");
            }
        ...
        throw new OperatorException("只能对 BigDecimal、BigInteger、Double、Float、Short、Integer、Byte、Long 八种数据类型进行除法运算");
    }
    ...
    public static boolean equal(Object left, Object right) {
        ...
        throw new OperatorException("只能对 BigDecimal、BigInteger、Double、Float、Short、Integer、Byte、Long、Enum、Character、Date、LocalDate、LocalDateTime 十三种数据类型进行比较运算");
    }
    ...
    private static long extractTimeStamp(Object object) {
        ...
        throw new OperatorException("只能对 Date 或 LocalDateTime 类型提取时间戳!");
    }
    ...
    private static void assertNotNull(Object object) {
        if (object == null) {
            throw new OperatorException("不能对 null 进行数学运算");
        }
    }
    ...
    public static Object like(Object left, Object right) {
        ...
        if (!(left instanceof String) || !(right instanceof String)) {
            throw new OperatorException("只能对 String 数据类型进行like运算");
        }
    ...
    public static Object contains(Object left, Object right) {
        ...
        throw new OperatorException("只能对 String 数据类型进行contains运算");
    }
